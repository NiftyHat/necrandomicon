...
:: Android packaging
set AND_CERT_NAME="Necrandomicon"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Necrandomicon.p12
...
set IOS_PROVISION=cert\Necrandomicon.mobileprovision
...
set APP_ID=air.Necrandomicon

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Necrandomicon
